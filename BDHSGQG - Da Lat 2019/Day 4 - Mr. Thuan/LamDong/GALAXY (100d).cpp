...
void bfs(int s)
{
	...
	//cerr << "Result for s1: " << s << ' ' << id << ' ' << tot_mn.first << ' ' << tot_mn.second << '\n';
	...
	//cerr << "Result for s2: " << s << ' ' << id << ' ' << tot_mn.first << ' ' << tot_mn.second << '\n';
	//if (id == 12)
	//{
	//	cerr << p[11] << ' ' << p[10] << '\n';
	//}
...
int32_t main()
{
	...
	while(1)
	{
		...
		{
			//cerr << "EDGE: " << upd[i].first << ' ' << upd[i].second << '\n';
			//cerr << "COL: " << col[upd[i].first] << ' ' << col[upd[i].second] << '\n';
